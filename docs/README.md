...
5. [工程风险台账](./RISK_REGISTER.md)：记录当前残余风险、影响和处理计划。
6. [模型说明](./MODEL_SPEC.md)：说明全口径收入预测模型边界、收入分项和字段建议。
7. [业务数据字典 V1](./BUSINESS_DATA_DICTIONARY_V1.md)：约定项目、场景、结果等核心字段。
8. [验收用例 V1](./BUSINESS_ACCEPTANCE_CASES_V1.md)：定义 P0/P1/P2 业务验收用例。
9. [最小回归检查清单](./SMOKE_CHECKLIST.md)：用于每次 UI 或逻辑改动后的 3-5 分钟人工烟测。
